...
![Strapi dashboard: create an entry form, arrow indicating the location of the category in the right side menu](/assets/images/strapi-v4/strapi-add-category.png)
